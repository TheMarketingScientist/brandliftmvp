...
def _heatmap(fig_df: pd.DataFrame, title: str = "Attribute Importance Heatmap"):
    ...
    # UPDATED: remove deprecated keyword args, use config + container width
...
if base_scores or improved_scores or comp_scores:
    ...
    if base_scores:
        with cols[idx]:
            ...
            st.session_state["client_channel"] = client_channel
            # UPDATED: remove deprecated keyword args, use config + container width
            st.plotly_chart(radar(base_scores, "Original Scores", "rgba(68, 93, 167, 0.45)", "rgba(68, 93, 167, 1.0)"), use_container_width=True, config={"displayModeBar": False, "responsive": True})
    ...
    if improved_scores:
        with cols[idx]:
            ...
            # UPDATED
            st.plotly_chart(radar(improved_scores, "Improved Scores", "rgba(107, 56, 148, 0.45)", "rgba(107, 56, 148, 1.0)"), use_container_width=True, config={"displayModeBar": False, "responsive": True})
        ...
        with cols[idx]:
            ...
            if comp_link:
                ...
                try:
                    ...
                    pass
            # UPDATED
            st.plotly_chart(radar(comp_scores, f"{comp_label} Scores", "rgba(42, 169, 161, 0.45)", "rgba(42, 169, 161, 1.0)"), use_container_width=True, config={"displayModeBar": False, "responsive": True})
